...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |      | Mute | Vol- | Vol+ | Prev | Play | Next |      | Ins  |Brigt-|Brigt+|      |
    * |------+------+------+------+------+-------------+------+------+------+------+------|
    * | Caps |      |      |      |      |      |      |      |      |      |      |      |
    * |------+------+------+------+------+------|------+------+------+------+------+------|
    * |      |      |      |      |RGBTgl|BKLTgl|      |      |      |      |      |      |
    ...
    */
	[3] = LAYOUT_preonic_1x2uC(KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
                               KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_INS, KC_BRID, KC_BRIU, KC_NO,
    ...
    */
	[4] = LAYOUT_preonic_1x2uC(KC_TILD, KC_EXLM,   KC_AT, KC_HASH, KC_NO,   KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_NO,
                               ...
                               KC_NO,   KC_PLUS, KC_MINS, KC_PSLS, KC_ASTR, KC_LPRN, KC_RPRN, KC_PSLS, KC_BSLS,  KC_DLR, KC_PERC, KC_NO,
